 ...
 */
public final class ChannelActionURLEvent extends AbstractURLEvent<ChannelActionEvent> implements InboundEvent, ChannelEvent, FromUserEvent, MessageRespondableEvent {

    public ChannelActionURLEvent(final ThimBot bot, final ChannelActionEvent parent, final URI uri) {
