 ...
 */
public final class ChannelMessageURLEvent extends AbstractURLEvent<ChannelMessageEvent> implements InboundEvent, ChannelEvent, FromUserEvent, MessageRespondableEvent {

    public ChannelMessageURLEvent(final ThimBot bot, final ChannelMessageEvent parent, final URI uri) {
